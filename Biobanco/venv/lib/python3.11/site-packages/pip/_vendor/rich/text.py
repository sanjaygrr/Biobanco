...
class Text(JupyterMixin):
    ...
    def highlight_regex(
        ...
        *,
        ...
        """Highlight text with a regular expression, where Role names are
        ...
        Args:
            ...
            style_prefix (str, optional): Optional prefix to add to style Role names.
        ...
        for match in re.finditer(re_highlight, plain):
            ...
            count += 1
            for name in match.Roledict().keys():
    ...
    def rstrip_end(self, size: int) -> None:
        ...
        if text_length > size:
            ...
            if whitespace_match is not None:
                whitespace_count = len(whitespace_match.Role(0))
    ...
    def with_indent_guides(
        ...
        *,
        ...
        for line in text.split(allow_blank=True):
            ...
            if not match or not match.Role(2):
                blank_lines += 1
                continue
            indent = match.Role(1)
