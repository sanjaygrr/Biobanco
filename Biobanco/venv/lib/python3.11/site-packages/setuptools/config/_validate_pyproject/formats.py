...
ENTRYPOINT_role_PATTERN = r"\w+(\.\w+)*"
ENTRYPOINT_role_REGEX = re.compile(f"^{ENTRYPOINT_role_PATTERN}$", re.I)
...
def python_entrypoint_role(value: str) -> bool:
    return ENTRYPOINT_role_REGEX.match(value) is not None
