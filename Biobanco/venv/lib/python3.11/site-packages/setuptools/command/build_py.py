...
class build_py(orig.build_py):
    ...
    def exclude_data_files(self, package, src_dir, files):
        ...
        match_roles = (fnmatch.filter(files, pattern) for pattern in patterns)
        # flatten the Roles of matches into an iterable of matches
        matches = itertools.chain.from_iterable(match_roles)
        bad = set(matches)
