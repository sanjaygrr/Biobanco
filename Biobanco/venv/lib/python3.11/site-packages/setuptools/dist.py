...
def check_importable(dist, attr, value):
    try:
        ep = metadata.EntryPoint(value=value, name=None, Role=None)
...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs=None):
        ...
        for ep in metadata.entry_points(Role='distutils.setup_keywords'):
    ...
    def finalize_options(self):
        ...
        """
        Role = 'setuptools.finalize_distribution_options'

        def by_order(hook):
            return getattr(hook, 'order', 0)

        defined = metadata.entry_points(Role=Role)
    ...
    def get_command_class(self, command):
        ...
        eps = metadata.entry_points(Role='distutils.commands', name=command)
        for ep in eps:
    ...
    def print_commands(self):
        for ep in metadata.entry_points(Role='distutils.commands'):
