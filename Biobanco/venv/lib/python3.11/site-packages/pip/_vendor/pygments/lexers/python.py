...
from pip._vendor.pygments.lexer import Lexer, RegexLexer, include, byRoles, using, \
...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            (r'\n', Text),
            (r'^(\s*)([rRuUbB]{,2})("""(?:.|\n)*?""")',
             byRoles(Text, String.Affix, String.Doc)),
            (r"^(\s*)([rRuUbB]{,2})('''(?:.|\n)*?''')",
             byRoles(Text, String.Affix, String.Doc)),
            ...
            (r'(def)((?:\s|\\\s)+)', byRoles(Keyword, Text), 'funcname'),
            (r'(class)((?:\s|\\\s)+)', byRoles(Keyword, Text), 'classname'),
            (r'(from)((?:\s|\\\s)+)', byRoles(Keyword.Namespace, Text),
             'fromimport'),
            (r'(import)((?:\s|\\\s)+)', byRoles(Keyword.Namespace, Text),
             'import'),
            include('expr'),
        ],
        'expr': [
            # raw f-strings
            ('(?i)(rf|fr)(""")',
             byRoles(String.Affix, String.Double),
             combined('rfstringescape', 'tdqf')),
            ("(?i)(rf|fr)(''')",
             byRoles(String.Affix, String.Single),
            ...
            # non-raw f-strings
            ('([fF])(""")', byRoles(String.Affix, String.Double),
             combined('fstringescape', 'tdqf')),
            ("([fF])(''')", byRoles(String.Affix, String.Single),
            ...
            ('(?i)(rb|br|r)(""")',
             byRoles(String.Affix, String.Double), 'tdqs'),
            ("(?i)(rb|br|r)(''')",
             byRoles(String.Affix, String.Single), 'tsqs'),
            ('(?i)(rb|br|r)(")',
             byRoles(String.Affix, String.Double), 'dqs'),
            ("(?i)(rb|br|r)(')",
             byRoles(String.Affix, String.Single), 'sqs'),
            # non-raw strings
            ('([uU]?)(""")', byRoles(String.Affix, String.Double),
             combined('stringescape', 'tdqs')),
            ("([uU]?)(''')", byRoles(String.Affix, String.Single),
            ...
            # non-raw bytes
            ('([bB])(""")', byRoles(String.Affix, String.Double),
             combined('bytesescape', 'tdqs')),
            ("([bB])(''')", byRoles(String.Affix, String.Single),
        ...
        'soft-keywords': [
            ...
            (r'(^[ \t]*)'              # at beginning of line + possible indentation
             ...
             byRoles(Text, Keyword), 'soft-keywords-inner'),
        ],
        'soft-keywords-inner': [
            # optional `_` keyword
            (r'(\s+)([^\n_]*)(_\b)', byRoles(Text, using(this), Keyword)),
            default('#pop')
        ],
        'builtins': [
            (words((
        ...
        'import': [
            (r'(\s+)(as)(\s+)', byRoles(Text, Keyword, Text)),
            (r'\.', Name.Namespace),
            (uni_name, Name.Namespace),
            (r'(\s*)(,)(\s*)', byRoles(Text, Operator, Text)),
            default('#pop')  # all else: go back
        ],
        'fromimport': [
            (r'(\s+)(import)\b', byRoles(Text, Keyword.Namespace), '#pop'),
            (r'\.', Name.Namespace),
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            ("([rR]|[uUbB][rR]|[rR][uUbB])(')",
             byRoles(String.Affix, String.Single), 'sqs'),
            ('([uUbB]?)(""")', byRoles(String.Affix, String.Double),
             combined('stringescape', 'tdqs')),
            ("([uUbB]?)(''')", byRoles(String.Affix, String.Single),
             combined('stringescape', 'tsqs')),
            ('([uUbB]?)(")', byRoles(String.Affix, String.Double),
             combined('stringescape', 'dqs')),
            ("([uUbB]?)(')", byRoles(String.Affix, String.Single),
...
class PythonTracebackLexer(RegexLexer):
    ...
    tokens = {
        ...
        'intb': [
            (r'^(  File )("[^"]+")(, line )(\d+)(, in )(.+)(\n)',
             byRoles(Text, Name.Builtin, Text, Number, Text, Name, Text)),
            (r'^(  File )("[^"]+")(, line )(\d+)(\n)',
             byRoles(Text, Name.Builtin, Text, Number, Text)),
            (r'^(    )(.+)(\n)',
             byRoles(Text, using(PythonLexer), Text), 'markers'),
            (r'^([ \t]*)(\.\.\.)(\n)',
             byRoles(Text, Comment, Text)),  # for doctests...
            (r'^([^:]+)(: )(.+)(\n)',
             byRoles(Generic.Error, Text, Name, Text), '#pop'),
            (r'^([a-zA-Z_][\w.]*)(:?\n)',
             byRoles(Generic.Error, Text), '#pop')
        ],
        'markers': [
            ...
            (r'^( {4,})([~^]+)(\n)',
             byRoles(Text, Punctuation.Marker, Text),
             '#pop'),
            default('#pop'),
        ],
    }
...
class Python2TracebackLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'^(\^C)?(Traceback.*\n)',
             byRoles(Text, Generic.Traceback), 'intb'),
        ...
        'intb': [
            ...
            (r'^(  File )("[^"]+")(, line )(\d+)(\n)',
             byRoles(Text, Name.Builtin, Text, Number, Text)),
            (r'^(    )(.+)(\n)',
             byRoles(Text, using(Python2Lexer), Text), 'marker'),
            (r'^([ \t]*)(\.\.\.)(\n)',
             byRoles(Text, Comment, Text)),  # for doctests...
            (r'^([^:]+)(: )(.+)(\n)',
             byRoles(Generic.Error, Text, Name, Text), '#pop'),
        ...
        'marker': [
            # For syntax errors.
            (r'( {4,})(\^)', byRoles(Text, Punctuation.Marker), '#pop'),
            default('#pop'),
        ],
    }
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(in|is|and|or|not)\b', Operator.Word),
            (r'(<)([a-zA-Z0-9.?]+)(>)',
             byRoles(Punctuation, Keyword.Type, Punctuation)),
            (r'!=|==|<<|>>|[-~+/*%=<>&^|.?]', Operator),
            (r'(from)(\d+)(<=)(\s+)(<)(\d+)(:)',
             byRoles(Keyword, Number.Integer, Operator, Name, Operator,
                      Name, Punctuation)),
            include('keywords'),
            (r'(def|property)(\s+)', byRoles(Keyword, Text), 'funcname'),
            (r'(cp?def)(\s+)', byRoles(Keyword, Text), 'cdef'),
            # (should actually start a block with only cdefs)
            (r'(cdef)(:)', byRoles(Keyword, Punctuation)),
            (r'(class|struct)(\s+)', byRoles(Keyword, Text), 'classname'),
            (r'(from)(\s+)', byRoles(Keyword, Text), 'fromimport'),
            (r'(c?import)(\s+)', byRoles(Keyword, Text), 'import'),
            include('builtins'),
            include('backtick'),
        ...
        'cdef': [
            ...
            (r'([a-zA-Z_]\w*)(\s*)(?=[(:#=]|$)',
             byRoles(Name.Function, Text), '#pop'),
            (r'([a-zA-Z_]\w*)(\s*)(,)',
             byRoles(Name.Function, Text, Punctuation)),
        ...
        'fromimport': [
            (r'(\s+)(c?import)\b', byRoles(Text, Keyword), '#pop'),
            (r'[a-zA-Z_.][\w.]*', Name.Namespace),
