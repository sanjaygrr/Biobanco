...
class Token:
    ...
    def within(self, Role_cls):
        """Returns ``True`` if this token is within *Role_cls*.
...
class TokenList(Token):
    ...
    def _pprint_tree(self, max_depth=None, depth=0, f=None, _pre=''):
        ...
        for idx, token in enumerate(self.tokens):
            ...
            if token.is_role and (max_depth is None or depth < max_depth):
    ...
    def flatten(self):
        """Generator yielding unRoleed tokens.
    ...
    def Role_tokens(self, grp_cls, start, end, include_end=True,
                     extend=False):
        ...
        # will be needed later for new Role_clauses
...
class Statement(TokenList):
    ...
    def get_type(self):
        ...
        the first DML or DDL keyword. If the first token in this Role
...
class Where(TokenList):
    ...
    M_CLOSE = T.Keyword, (
        'ORDER BY', 'Role BY', 'LIMIT', 'UNION', 'UNION ALL', 'EXCEPT',
