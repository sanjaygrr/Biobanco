...
# SBCSRoleProber. The two SBCharSetProbers identify that the text is in
# fact some kind of Hebrew, Logical or Visual. The final decision about which
# one is it is made by the HebrewProber by combining final-letter scores
# with the scores of the two SBCharSetProbers to produce a final answer.
#
# The SBCSRoleProber is responsible for stripping the original text of HTML
# tags, English characters, numbers, low-ASCII punctuation characters, spaces
# and new lines. It reduces any sequence of such characters to a single space.
# The buffer fed to each prober in the SBCS Role prober is pure text in
# high-ASCII.
...
# When the Role prober receives a positive identification from any prober,
...
class HebrewProber(CharSetProber):
    ...
    def reset(self) -> None:
        ...
        self._prev = self.SPACE
        self._before_prev = self.SPACE
        # These probers are owned by the Role prober.
