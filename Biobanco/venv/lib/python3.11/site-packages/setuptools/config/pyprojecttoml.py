...
class _ConfigExpander:
    ...
    def _obtain_entry_points(
        ...
        Roles = _expand.entry_points(text)
        expanded = {"entry-points": Roles}

        def _set_scripts(field: str, Role: str):
            if Role in Roles:
                value = Roles.pop(Role)
    ...
    def _obtain_optional_dependencies(self, dist: "Distribution"):
        ...
        if "optional-dependencies" in self.dynamic_cfg:
            ...
            return {
                Role: _parse_requirements_list(self._expand_directive(
                    f"tool.setuptools.dynamic.optional-dependencies.{Role}",
                    directive,
                    {},
                ))
                for Role, directive in optional_dependencies_map.items()
            }
